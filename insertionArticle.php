...
<?php 
 ...
 $connect = mysqli_connect("localhost", "root", "", "blogPHP"); 
...
//vaut 0  
   ...
   if ((isset($_FILES['photo']['name'])&&($_FILES['photo']['error'] == UPLOAD_ERR_OK))) { 
      $chemin_destination = '/home/vivi/dev/stockageImg/photos/'; 
...
$requete = "INSERT INTO Article (Titre, Date, Commentaire, Photo, lat, lng) VALUES ('".htmlentities(addslashes($_POST['titre']), ENT_QUOTES)."','".date("Y-m-d H:i:s")."','".htmlentities (addslashes($_POST['commentaire']), ENT_QUOTES)."', '".$_FILES['photo']['name']."', '".htmlentities(addslashes($_POST['lat']), ENT_QUOTES)."', '".htmlentities(addslashes($_POST['lng']), ENT_QUOTES)."')"; 
echo $requete;
